...
class Claim(models.Model):
    ...
    requester = models.CharField( max_length=25 ,verbose_name='مقدمة عن طريق') # should be username here.....
    ...
    image = models.ImageField( upload_to='claimsfile/', height_field=None, width_field=None, max_length=None, null = True , blank = True)
